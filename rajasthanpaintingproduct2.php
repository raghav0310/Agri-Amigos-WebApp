			...
			<div class="row product_row">
				...
				<div class="col-lg-7">
					<div class="product_image">
						<div class="product_image_large"><img src="images/rajasthan/Desert-Dawn-watercolor-painting-by-ananta-mandal_0.jpg" alt=""></div>
				...
				<div class="col-lg-5">
					<div class="product_content">
						<div class="product_name">Painting Item</div>
						<div class="product_price">₹4500</div>
